...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'scheme.about.description3': 'The scheme offers various plot sizes and locations across different regions, with flexible payment options and easy installment plans. All applications are processed digitally.',
  ...
  hi: {
    ...
    'scheme.about.description3': 'यह योजना विभिन्न क्षेत्रों में विभिन्न प्लॉट आकार और स्थान प्रदान करती है, जिसमें लचीले भुगतान विकल्प और आसान किस्त योजनाएं शामिल हैं। सभी आवेदन डिजिटल रूप से संसाधित किए जाते हैं, और आवेदक पोर्टल के माध्यम से अपनी आवेदन स्थिति को वास्तविक समय में ट्रैक कर सकते हैं।',
